...
using UnityEngine;
    ...
    public class CharacterMovement2DDrug : CharacterMovementBaseDrug
    {
    ...
    {
        if (MoveInput == null) _dashDirection = transform.forward;
        else _dashDirection = MoveInput;

        _rigidbody.AddForce(_dashDirection * _dashForce);
    }
